  ...
  return (
    <main id="top">
      <header className="site-header">
        ...
        <nav aria-label="主导航"><a href="#work">项目</a><a href="#research">研究</a><a href="#experience">经历</a><a className="nav-cta" href="#contact">联系我 ↗</a></nav>
      </header>

      <section className="hero section-shell">
        <div className="hero-copy" data-reveal>
          <p className="eyebrow"><i /> FDE · AI 应用交付 · 前端体验</p>
          <h1><span className="hero-line">把真实业务需求，</span><span className="hero-line">做成<em>可用、</em></span><span className="hero-line"><em>可核验</em>的 AI 应用。</span></h1>
          <p className="hero-summary">我是 Shay / 杨舒雅。我关注用户和商家实际遇到的问题，完成需求梳理、AI 工作流、前端界面和演示交付。</p>
          <div className="hero-actions"><a className="button button-primary" href="#work">查看项目 ↓</a><a className="button button-secondary" href="#contact">联系 Shay ↗</a></div>
        ...
        <div className="hero-lanyard" data-reveal>
          <Lanyard frontImage="/assets/profile/profile-02.jpg" backImage="/assets/profile/profile-02.jpg" />
          <p>拖动吊牌试试 · 原图比例完整保留</p>
        </div>
      </section>
      ...
      <section id="work" className="work">
        <div className="section-shell section-heading" data-reveal><div><span className="section-index">01 / SELECTED WORK</span><h2>项目怎样被做出来，<br />结果怎样被验证。</h2></div><p>页面中的数据、界面与公开反馈都来自实际项目材料。</p></div>
        ...
        <article className="case section-shell" data-reveal>
          ...
          <div className="case-copy"><div className="case-kicker"><span>AI 经营洞察工作台</span><span>REACT + FASTAPI</span></div><h3>把评论变成可追溯的经营建议和 Listing 优化方案。</h3><p className="case-lead">导入评论后，系统完成清洗、分类、痛点排序、行动建议、Listing 优化和报告导出。结论保留原文证据，运营人员可以核验后再执行。</p><div className="metric-row"><div><strong>200</strong><span>演示评论样本</span></div><div><strong>34</strong><span>高优先级痛点</span></div><div><strong>7</strong><span>待执行建议</span></div></div><dl className="fact-list"><div><dt>我的工作</dt><dd>产品梳理、前端 UI、AI 工作流和演示交付</dd></div><div><dt>交付边界</dt><dd>保留原文证据，不伪造评分，不自动发布</dd></div><div><dt>技术</dt><dd>React · TypeScript · FastAPI · pandas · LLM API</dd></div></dl><a className="text-link" href="https://github.com/yshuya530-svg/EcomLens-AI" target="_blank" rel="noreferrer">查看 GitHub ↗</a></div>
        </article>
        ...
        <article className="agent-case section-shell" data-reveal>
          ...
          <div className="agent-stage"><DepthCarousel items={agentShots} cardWidth={370} cardHeight={555} stageHeight={690} depth={115} spread={76} tilt={10} visibleCards={5} fit="contain" /></div>
        </article>
      ...
      <section id="experience" className="experience section-shell">
        <div className="section-heading" data-reveal><div><span className="section-index">03 / FIELD NOTES</span><h2>现场采集、内容制作<br />与公开发布。</h2></div><p>所有画面按原图展示；点击可看完整大图。</p></div>
        ...
        <article className="experience-case experience-case-alt" data-reveal><div className="experience-copy"><span>2025 / MEDIA DELIVERY</span><h3>微视河南文化传媒中心</h3><p>参与公开内容采编、平台风格适配与多渠道分发。作者署名、阅读量和转载页面构成可核验的工作记录。</p><div className="experience-tags"><span>内容采编</span><span>平台适配</span><span>多渠道分发</span><span>公开传播</span></div></div><CircularGallery items={weishiShots} /></article>
      </section>
      ...
      <footer id="contact"><div className="section-shell footer-main"><span>LET&apos;S BUILD SOMETHING USEFUL</span><h2>如果你在寻找<br />能理解需求、完成界面，<br /><em>也能把 AI 应用交付出来的人，</em><br />欢迎来聊。</h2><div className="contact-grid"><a href="mailto:15669517568@163.com"><span>EMAIL</span><b>15669517568@163.com</b><i>↗</i></a><a href="tel:15669517568"><span>PHONE</span><b>156 6951 7568</b><i>↗</i></a><div><span>WECHAT</span><b>lxyg0228</b><i>复制添加</i></div></div></div><div className="section-shell footer-bottom"><span>© 2026 SHAY / YANG SHUYA</span><span>AI APPLICATION DELIVERY · FRONTEND UI</span><a href="#top">BACK TO TOP ↑</a></div></footer>
    </main>
  );
}
